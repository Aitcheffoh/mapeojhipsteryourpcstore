...
class CustomerResourceIT {
    ...
    private static final Long DEFAULT_CELPHONE = 1L;
    private static final Long UPDATED_CELPHONE = 2L;

    private static final LocalDate DEFAULT_DATE = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_DATE = LocalDate.now(ZoneId.systemDefault());

    private static final Sex DEFAULT_SEX_TYPE = Sex.MALE;
    private static final Sex UPDATED_SEX_TYPE = Sex.FEMALE;
    ...
    void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getNames()).isEqualTo(DEFAULT_NAMES);
        assertThat(testCustomer.getLastNames()).isEqualTo(DEFAULT_LAST_NAMES);
        assertThat(testCustomer.getEmail()).isEqualTo(DEFAULT_EMAIL);
        assertThat(testCustomer.getPassword()).isEqualTo(DEFAULT_PASSWORD);
        assertThat(testCustomer.getPhone()).isEqualTo(DEFAULT_PHONE);
        assertThat(testCustomer.getCelphone()).isEqualTo(DEFAULT_CELPHONE);
        assertThat(testCustomer.getDate()).isEqualTo(DEFAULT_DATE);
        assertThat(testCustomer.getSexType()).isEqualTo(DEFAULT_SEX_TYPE);
    ...
    @Test
    @Transactional
    void checkLastNamesIsRequired() throws Exception {
        int databaseSizeBeforeTest = customerRepository.findAll().size();
        // set the field null
        customer.setLastNames(null);
    ...
    @Test
    @Transactional
    void checkCelphoneIsRequired() throws Exception {
        int databaseSizeBeforeTest = customerRepository.findAll().size();
        // set the field null
        customer.setCelphone(null);
    ...
    @Test
    @Transactional
    void checkSexTypeIsRequired() throws Exception {
        int databaseSizeBeforeTest = customerRepository.findAll().size();
        // set the field null
        customer.setSexType(null);
    ...
    void getAllCustomers() throws Exception {
        ...
        restCustomerMockMvc
            ...
            .andExpect(jsonPath("$.[*].celphone").value(hasItem(DEFAULT_CELPHONE.intValue())))
    ...
    void getCustomer() throws Exception {
        ...
        restCustomerMockMvc
            ...
            .andExpect(jsonPath("$.celphone").value(DEFAULT_CELPHONE.intValue()))
    ...
    void putNewCustomer() throws Exception {
        ...
        Customer testCustomer = customerList.get(customerList.size() - 1);
        assertThat(testCustomer.getNames()).isEqualTo(UPDATED_NAMES);
        assertThat(testCustomer.getLastNames()).isEqualTo(UPDATED_LAST_NAMES);
        assertThat(testCustomer.getEmail()).isEqualTo(UPDATED_EMAIL);
        assertThat(testCustomer.getPassword()).isEqualTo(UPDATED_PASSWORD);
        assertThat(testCustomer.getPhone()).isEqualTo(UPDATED_PHONE);
        assertThat(testCustomer.getCelphone()).isEqualTo(UPDATED_CELPHONE);
        assertThat(testCustomer.getDate()).isEqualTo(UPDATED_DATE);
        assertThat(testCustomer.getSexType()).isEqualTo(UPDATED_SEX_TYPE);
    ...
    void partialUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.names(UPDATED_NAMES).phone(UPDATED_PHONE).sexType(UPDATED_SEX_TYPE).state(UPDATED_STATE);
