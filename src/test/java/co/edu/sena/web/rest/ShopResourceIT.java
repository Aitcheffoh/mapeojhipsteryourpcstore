...
class ShopResourceIT {
    ...
    private static final String DEFAULT_NAME_SHOP = "AAAAAAAAAA";
    private static final String UPDATED_NAME_SHOP = "BBBBBBBBBB";

    private static final String DEFAULT_PLACE = "AAAAAAAAAA";
    private static final String UPDATED_PLACE = "BBBBBBBBBB";

    private static final Long DEFAULT_PHONE_SHOP = 1L;
    private static final Long UPDATED_PHONE_SHOP = 2L;
    ...
    public static Shop createEntity(EntityManager em) {
        Shop shop = new Shop().nameShop(DEFAULT_NAME_SHOP).place(DEFAULT_PLACE).phoneShop(DEFAULT_PHONE_SHOP);
        return shop;
    }
    ...
    public static Shop createUpdatedEntity(EntityManager em) {
        Shop shop = new Shop().nameShop(UPDATED_NAME_SHOP).place(UPDATED_PLACE).phoneShop(UPDATED_PHONE_SHOP);
        return shop;
    }
    ...
    void createShop() throws Exception {
        ...
        assertThat(testShop.getNameShop()).isEqualTo(DEFAULT_NAME_SHOP);
        assertThat(testShop.getPlace()).isEqualTo(DEFAULT_PLACE);
        assertThat(testShop.getPhoneShop()).isEqualTo(DEFAULT_PHONE_SHOP);
    }
    ...
    @Test
    @Transactional
    void checkNameShopIsRequired() throws Exception {
        int databaseSizeBeforeTest = shopRepository.findAll().size();
        // set the field null
        shop.setNameShop(null);
    ...
    @Test
    @Transactional
    void checkPhoneShopIsRequired() throws Exception {
        int databaseSizeBeforeTest = shopRepository.findAll().size();
        // set the field null
        shop.setPhoneShop(null);
    ...
    void getAllShops() throws Exception {
        ...
        restShopMockMvc
            ...
            .andExpect(jsonPath("$.[*].nameShop").value(hasItem(DEFAULT_NAME_SHOP)))
            .andExpect(jsonPath("$.[*].place").value(hasItem(DEFAULT_PLACE)))
            .andExpect(jsonPath("$.[*].phoneShop").value(hasItem(DEFAULT_PHONE_SHOP.intValue())));
    }
    ...
    void getShop() throws Exception {
        ...
        restShopMockMvc
            ...
            .andExpect(jsonPath("$.nameShop").value(DEFAULT_NAME_SHOP))
            .andExpect(jsonPath("$.place").value(DEFAULT_PLACE))
            .andExpect(jsonPath("$.phoneShop").value(DEFAULT_PHONE_SHOP.intValue()));
    }
    ...
    void putNewShop() throws Exception {
        ...
        updatedShop.nameShop(UPDATED_NAME_SHOP).place(UPDATED_PLACE).phoneShop(UPDATED_PHONE_SHOP);
        ...
        Shop testShop = shopList.get(shopList.size() - 1);
        assertThat(testShop.getNameShop()).isEqualTo(UPDATED_NAME_SHOP);
        assertThat(testShop.getPlace()).isEqualTo(UPDATED_PLACE);
        assertThat(testShop.getPhoneShop()).isEqualTo(UPDATED_PHONE_SHOP);
    }
    ...
    void partialUpdateShopWithPatch() throws Exception {
        ...
        partialUpdatedShop.phoneShop(UPDATED_PHONE_SHOP);
    ...
    void fullUpdateShopWithPatch() throws Exception {
        ...
        partialUpdatedShop.nameShop(UPDATED_NAME_SHOP).place(UPDATED_PLACE).phoneShop(UPDATED_PHONE_SHOP);
