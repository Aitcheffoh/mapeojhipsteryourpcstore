...
describe('Product Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Dealer query and add missing value', () => {
      ...
      const dealer: IDealer = { id: 57259 };
      product.dealer = dealer;
      const productList: IDealer = { id: 36378 };
      product.productList = productList;

      const dealerCollection: IDealer[] = [{ id: 33371 }];
      jest.spyOn(dealerService, 'query').mockReturnValue(of(new HttpResponse({ body: dealerCollection })));
      const additionalDealers = [dealer, productList];
    ...
    it('Should update editForm', () => {
      const product: IProduct = { id: 456 };
      const dealer: IDealer = { id: 94923 };
      product.dealer = dealer;
      const productList: IDealer = { id: 54666 };
      product.productList = productList;
      ...
      expect(comp.dealersSharedCollection).toContain(productList);
    });
  });
