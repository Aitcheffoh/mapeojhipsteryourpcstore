...
class Carousel extends BaseComponent {
  ...
  _slide(e, t) {
    ...
    if (this._element.classList.contains('slide')) {
      ...
      const e = () => {
        o.classList.remove(c, E), o.classList.add('active'), i.classList.remove('active', E, c), (this._isSliding = !1), setTimeout(h, 0);
      };
  ...
  show() {
    ...
    this._parent &&
      ((e = SelectorEngine.find(SELECTOR_ACTIVES, this._parent).filter(e =>
        'string' == typeof this._config.parent ? e.getAttribute('data-bs-parent') === this._config.parent : e.classList.contains('collapse')
      )),
      0 === e.length && (e = null));
...
EventHandler.on(document, EVENT_CLICK_DATA_API$4, SELECTOR_DATA_TOGGLE$4, function (e) {
  ...
  SelectorEngine.find(n).forEach(e => {
    ...
    let i;
    n
      ? (null === n._parent && 'string' == typeof t.parent && ((n._config.parent = t.parent), (n._parent = n._getParent())), (i = 'toggle'))
      : (i = t),
...
class Tooltip extends BaseComponent {
  ...
  show() {
    ...
    Data.set(i, this.constructor.DATA_KEY, this),
      ...
      this._popper ? this._popper.update() : (this._popper = Popper.createPopper(this._element, i, this._getPopperConfig(r))),
  ...
  setElementContent(e, t) {
    if (null !== e)
      return isElement(t)
        ? ((t = getElement(t)),
          void (this._config.html ? t.parentNode !== e && ((e.innerHTML = ''), e.appendChild(t)) : (e.textContent = t.textContent)))
  ...
  _initializeOnDelegatedTarget(e, t) {
    ...
    return (
      (t = t || Data.get(e.delegateTarget, n)) ||
        ((t = new this.constructor(e.delegateTarget, this._getDelegateConfig())), Data.set(e.delegateTarget, n, t)),
      t
    );
  }
  _getOffset() {
...
class ScrollSpy extends BaseComponent {
  ...
  _getConfig(e) {
    if (
      'string' !=
        typeof (e = { ...Default$1, ...Manipulator.getDataAttributes(this._element), ...('object' == typeof e && e ? e : {}) }).target &&
      isElement(e.target)
    ) {
      let { id: t } = e.target;
  ...
  _activate(e) {
    ...
    n.classList.contains('dropdown-item')
      ? (SelectorEngine.findOne('.dropdown-toggle', n.closest('.dropdown')).classList.add('active'), n.classList.add('active'))
...
class Tab extends BaseComponent {
  ...
  show() {
    ...
    if (EventHandler.trigger(this._element, EVENT_SHOW$1, { relatedTarget: e }).defaultPrevented || (null !== i && i.defaultPrevented))
      return;
