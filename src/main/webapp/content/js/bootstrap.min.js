...
!(function (t, e) {
  ...
  class nt extends q {
    ...
    static collapseInterface(t, e) {
      ...
      if (
        (!s && i.toggle && 'string' == typeof e && /show|hide/.test(e) && (i.toggle = !1), s || (s = new nt(t, i)), 'string' == typeof e)
      ) {
  ...
  B.on(document, 'click.bs.collapse.data-api', '[data-bs-toggle="collapse"]', function (t) {
    ...
    i.find(s).forEach(t => {
      ...
      let i;
      s
        ? (null === s._parent && 'string' == typeof e.parent && ((s._config.parent = e.parent), (s._parent = s._getParent())),
          (i = 'toggle'))
        : (i = e),
